...
// ==== A1 OTÁZKY A ODPOVĚDI (z dokumentu „Nemcina zkouska priprava") ====
// Q&A styl: pro každé téma sada otázka/odpověď + slovní zásoba + tipy.
const EXAM_PREP_A1 = {
  intro: {
    title: "Příprava na zkoušku z němčiny",
    subtitle: "Úroveň A1 — Otázky a odpovědi",
    person: "Jaro, 29 let, Jeseník",
  },
  greeting: [
    ["Guten Tag! Ich heiße Jaro.", "Dobrý den, jmenuji se Jaro."],
    ["Ich bin neunundzwanzig Jahre alt.", "Je mi 29 let."],
    ["Ich komme aus Tschechien und wohne in Jeseník.", "Jsem z Česka a bydlím v Jeseníku."],
    ["Ich studiere in Šumperk und ich bin auch DJ.", "Studuji v Šumperku a jsem také DJ."],
    ["Ich habe keine Geschwister und keine Kinder.", "Nemám sourozence ani děti."],
    ["Meine Hobbys sind Fitness und Musik.", "Mé koníčky jsou fitness a hudba."],
    ["Im Sommer fahre ich in die Schweiz.", "V létě jedu do Švýcarska."],
  ],
  topics: [
    {
      id: "vorstellen", emoji: "👋", title: "Představení", de: "sich vorstellen",
      qas: [
        { q: "Wie heißen Sie?", qcz: "Jak se jmenujete?",
          answers: [["Ich heiße Jaro.", "Jmenuji se Jaro."]] },
        { q: "Wie alt sind Sie?", qcz: "Kolik je vám let?",
          answers: [["Ich bin neunundzwanzig Jahre alt.", "Je mi 29 let."]],
          tip: "V němčině se říká nejdřív jednotky, pak desítky → neun-und-zwanzig (devět-a-dvacet)." },
        { q: "Woher kommen Sie?", qcz: "Odkud pocházíte?",
          answers: [["Ich komme aus Tschechien.", "Pocházím z Česka."]] },
        { q: "Wo wohnen Sie?", qcz: "Kde bydlíte?",
          answers: [["Ich wohne in Jeseník.", "Bydlím v Jeseníku."]] },
        { q: "Was sind Sie von Beruf? / Was machen Sie?", qcz: "Co děláte / jaké máte povolání?",
          answers: [
            ["Ich bin Student. Ich studiere in Šumperk.", "Jsem student. Studuji v Šumperku."],
            ["Ich bin auch Datenanalyst und DJ.", "Jsem také dataanalist a DJ."],
          ] },
      ],
    },
    {
      id: "reisen", emoji: "🧳", title: "Cestování", de: "Reisen",
      qas: [
        { q: "Wohin fahren Sie im Sommer?", qcz: "Kam jedete v létě?",
          answers: [["Ich fahre im Sommer in die Schweiz.", "V létě jedu do Švýcarska."]] },
        { q: "Mit wem fahren Sie?", qcz: "S kým jedete?",
          answers: [
            ["Ich fahre mit Freunden.", "Jedu s přáteli."],
            ["Ich fahre allein.", "Jedu sám."],
          ] },
        { q: "Wie fahren Sie? / Womit fahren Sie?", qcz: "Jak / čím jedete?",
          answers: [
            ["Ich fahre mit dem Auto.", "Jedu autem."],
            ["Ich fahre mit dem Zug.", "Jedu vlakem."],
          ] },
        { q: "Wie lange bleiben Sie dort?", qcz: "Jak dlouho tam zůstanete?",
          answers: [
            ["Ich bleibe eine Woche.", "Zůstanu týden."],
            ["Ich bleibe zwei Wochen.", "Zůstanu dva týdny."],
          ] },
      ],
      vocab: [
        ["fahren", "jet (autem, vlakem)"],
        ["fliegen", "letět"],
        ["der Sommer", "léto"],
        ["der Urlaub", "dovolená"],
        ["die Schweiz", "Švýcarsko"],
        ["in die Schweiz", "do Švýcarska"],
        ["der Freund / die Freunde", "přítel / přátelé"],
        ["das Auto", "auto"],
        ["der Zug", "vlak"],
    ...
    {
      id: "casovani", emoji: "📚", title: "Časování pravidelných sloves", de: "Konjugation",
      conjugation: {
        verb: "machen",
        cz: "dělat",
        forms: [
          ...
          ["ihr macht", "vy (tykání) děláte"],
          ["sie / Sie machen", "oni / Vy (vykání) dělají/děláte"],
        ],
      },
      vocab: [
        ["wohnen", "bydlet"],
        ["kommen", "přijít / přicházet"],
        ["spielen", "hrát"],
        ["lernen", "učit se"],
        ["arbeiten", "pracovat"],
        ["trinken", "pít"],
      ...
      tip: "Nepravidelná slovesa: essen → ich esse, du isst, er isst | fahren → ich fahre, du fährst, er fährt | haben → ich habe, du hast, er hat | sein → ich bin, du bist, er ist.",
    },
    {
      id: "nabytek", emoji: "🪑", title: "Nábytek doma a v kanceláři", de: "Möbel",
      qas: [
        { q: "Was haben Sie zu Hause?", qcz: "Co máte doma?",
          answers: [
            ["Ich habe einen Tisch, einen Stuhl und ein Bett.", "Mám stůl, židli a postel."],
            ["Ich habe einen Tisch für mein DJ-Equipment.", "Mám stůl na DJ vybavení."],
          ] },
        { q: "Was haben Sie im Büro / im Zimmer?", qcz: "Co máte v kanceláři / v pokoji?",
          answers: [["Im Zimmer habe ich einen Computer, einen Tisch und einen Stuhl.", "V pokoji mám počítač, stůl a židli."]] },
      ],
      vocab: [
        ["der Tisch", "stůl"],
        ["der Stuhl", "židle"],
        ...
        ["die Lampe", "lampa"],
        ["das Regal", "regál / police"],
        ["das Fenster", "okno"],
        ["die Tür", "dveře"],
      ],
      tip: "Pozor na rod: einen (mužský) Tisch, eine (ženská) Lampe, ein (střední) Bett.",
    },
    {
      id: "cas", emoji: "🕐", title: "Kolik je hodin?", de: "Wie spät ist es?",
      qas: [
        { q: "Wie spät ist es?", qcz: "Kolik je hodin?",
          answers: [
            ["Es ist acht Uhr.", "Je osm hodin."],
            ["Es ist halb neun.", "Je půl deváté. (doslova: půl k deváté)"],
            ["Es ist Viertel nach acht.", "Je čtvrt na devět. (čtvrt po osmé)"],
            ["Es ist Viertel vor neun.", "Je tři čtvrtě na devět. (čtvrt před devátou)"],
          ] },
      ],
      vocab: [
        ...
        ["Es ist Viertel nach drei.", "Je čtvrt na čtyři."],
        ["Es ist Viertel vor vier.", "Je tři čtvrtě na čtyři."],
        ["Es ist zehn nach fünf.", "Je 5:10."],
        ["Es ist zwanzig vor sechs.", "Je 5:40."],
        ["Es ist Mittag.", "Je poledne."],
        ["Es ist Mitternacht.", "Je půlnoc."],
      ],
      tip: "Pozor: 'halb neun' = 8:30 (ne 9:30!) — je to půl k deváté.",
    },
    {
      id: "essen", emoji: "🍽️", title: "Jídlo a pití", de: "Essen und Trinken",
      qas: [
        { q: "Was essen Sie gern?", qcz: "Co rád jíte?",
          answers: [["Ich esse gern Steak und Burger.", "Rád jím steak a burger."]] },
        { q: "Essen Sie Fleisch?", qcz: "Jíte maso?",
          answers: [["Ja, ich esse gern Fleisch.", "Ano, rád jím maso."]] },
        { q: "Was trinken Sie gern?", qcz: "Co rád pijete?",
          answers: [
            ["Ich trinke gern Wasser.", "Rád piju vodu."],
            ["Manchmal trinke ich Bier mit Freunden.", "Občas piju pivo s přáteli."],
          ] },
        { q: "Was essen Sie zum Frühstück?", qcz: "Co jíte k snídani?",
          answers: [["Zum Frühstück esse ich Brot mit Butter.", "K snídani jím chléb s máslem."]] },
      ],
      vocab: [
        ["essen", "jíst"],
        ["trinken", "pít"],
    ...
    {
      id: "wetter", emoji: "☀️", title: "Počasí a oblečení", de: "Wetter und Kleidung",
      qas: [
        { q: "Wie ist das Wetter heute?", qcz: "Jaké je dnes počasí?",
          answers: [
            ["Heute ist es sonnig und warm.", "Dnes je slunečno a teplo."],
            ["Heute ist es kalt.", "Dnes je zima."],
            ["Heute regnet es.", "Dnes prší."],
            ["Heute schneit es.", "Dnes sněží."],
          ] },
        { q: "Was haben Sie an?", qcz: "Co máte na sobě?",
          answers: [["Ich habe ein blaues T-Shirt, einen blauen Pullover und eine Hose an.", "Mám na sobě modré tričko, modrý svetr a kalhoty."]] },
        { q: "Welche Farbe haben Sie gern? / Welche Farbe mögen Sie?", qcz: "Jakou barvu máte rád?",
          answers: [["Ich mag Schwarz und Blau.", "Mám rád černou a modrou."]] },
      ],
      vocab: [
        ["sonnig", "slunečno"],
        ["warm", "teplo"],
        ...
        ["es schneit", "sněží"],
        ["windig", "větrno"],
        ["wolkig / bewölkt", "zataženo"],
        ["der Frühling", "jaro"],
        ["der Sommer", "léto"],
        ["der Herbst", "podzim"],
        ["der Winter", "zima (období)"],
      ],
      vocab2Title: "Oblečení",
      vocab2: [
        ["das T-Shirt", "tričko"],
        ["der Pullover", "svetr"],
        ["die Hose", "kalhoty"],
      ...
      tip: "Když přídavné jméno stojí PŘED podstatným jménem se členem, koncovka se mění: ein blau-es T-Shirt (střední rod), ein blau-er Pullover (mužský rod), eine blau-e Hose (ženský rod).",
    },
    {
      id: "wohnen", emoji: "🏠", title: "Bydlení", de: "Wohnen",
      qas: [
        { q: "Wo wohnen Sie?", qcz: "Kde bydlíte?",
          answers: [["Ich wohne in Jeseník.", "Bydlím v Jeseníku."]] },
        { q: "Haben Sie ein Haus?", qcz: "Máte dům?",
          answers: [["Nein, ich habe kein Haus. Ich habe eine Wohnung.", "Ne, nemám dům. Mám byt."]] },
        { q: "Wie ist Ihre Wohnung?", qcz: "Jaký je váš byt?",
          answers: [["Meine Wohnung ist klein, aber schön.", "Můj byt je malý, ale hezký."]] },
      ],
      vocab: [
        ["das Haus", "dům"],
        ["die Wohnung", "byt"],
        ["das Zimmer", "pokoj"],
        ["die Küche", "kuchyně"],
        ["das Badezimmer", "koupelna"],
        ["das Schlafzimmer", "ložnice"],
        ["das Wohnzimmer", "obývák"],
        ["wohnen", "bydlet"],
      ],
    },
    {
      id: "familie", emoji: "👨‍👩‍👧", title: "Rodina", de: "Familie",
      qas: [
        { q: "Haben Sie eine Schwester oder einen Bruder?", qcz: "Máte sestru nebo bratra?",
          answers: [["Nein, ich habe keine Schwester und keinen Bruder. Ich bin Einzelkind.", "Ne, nemám sestru ani bratra. Jsem jedináček."]] },
        { q: "Haben Sie Kinder?", qcz: "Máte děti?",
          answers: [["Nein, ich habe keine Kinder.", "Ne, nemám děti."]] },
        { q: "Sind Sie verheiratet?", qcz: "Jste ženatý?",
          answers: [["Nein, ich bin nicht verheiratet.", "Ne, nejsem ženatý."]] },
      ],
      vocab: [
        ["die Familie", "rodina"],
        ["die Mutter", "matka"],
      ...
      tip: "Zápor s 'kein': u podstatných jmen → ich habe KEIN Haus / KEINE Schwester / KEINEN Bruder. U sloves se používá 'nicht': ich bin NICHT verheiratet.",
    },
    {
      id: "studium", emoji: "🎓", title: "Studium", de: "Studium",
      qas: [
        { q: "Studieren Sie in Šumperk?", qcz: "Studujete v Šumperku?",
          answers: [["Ja, ich studiere in Šumperk.", "Ano, studuji v Šumperku."]] },
        { q: "Was studieren Sie?", qcz: "Co studujete?",
          answers: [["Ich studiere Buchhaltung / Wirtschaft.", "Studuji účetnictví / ekonomiku."]] },
      ],
    },
    {
      id: "hobbys", emoji: "🎵", title: "Záliby a volný čas", de: "Hobbys",
      qas: [
        { q: "Was machen Sie gern? / Was sind Ihre Hobbys?", qcz: "Co rád děláte? / Jaké máte koníčky?",
          answers: [
            ["Ich gehe gern ins Fitnessstudio.", "Rád chodím do posilovny."],
            ["Ich bin DJ. Ich mache gern Musik.", "Jsem DJ. Rád dělám hudbu."],
          ] },
        { q: "Was machen Sie am Wochenende?", qcz: "Co děláte o víkendu?",
          answers: [["Am Wochenende gehe ich ins Fitnessstudio und treffe Freunde.", "O víkendu chodím do gymu a scházím se s přáteli."]] },
      ],
      vocab: [
        ["das Hobby / die Hobbys", "koníček / koníčky"],
        ["das Fitnessstudio", "posilovna / gym"],
        ["ins Fitnessstudio gehen", "chodit do gymu"],
        ["die Musik", "hudba"],
        ["Musik machen", "dělat hudbu"],
        ["Musik hören", "poslouchat hudbu"],
        ["Freunde treffen", "scházet se s přáteli"],
        ["lesen", "číst"],
        ["schwimmen", "plavat"],
      ],
    },
  ...
  tips: [
    "Nauč se nejdřív představení nazpaměť — to ti dá sebevědomí na začátku zkoušky.",
    "Procvičuj nahlas — německá výslovnost se učí ústy, ne očima.",
    "Pamatuj si rody podstatných jmen společně se členem (DER Tisch, DIE Lampe, DAS Bett).",
    'Pokud nerozumíš otázce, klidně řekni: „Können Sie das wiederholen, bitte?" (Můžete to zopakovat, prosím?)',
    'Když nevíš odpověď, řekni „Ich weiß nicht." (Nevím.) — to je lepší než mlčet.',
  ],
};
